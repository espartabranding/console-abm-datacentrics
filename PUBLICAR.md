...
git commit -m "Console ABM DataCentrics V4"
git branch -M main
git remote add origin https://github.com/<usuario>/console-abm-datacentrics.git
git push -u origin main
```

> O arquivo tem 3,7 MB — bem abaixo do limite de 100 MB do GitHub.
> Se já existir uma versão anterior no repositório, basta substituir o `index.html`.
