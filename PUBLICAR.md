...
git commit -m "Console ABM DataCentrics V5"
git branch -M main
git remote add origin https://github.com/<usuario>/console-abm-datacentrics.git
git push -u origin main
```

> O arquivo tem 3,9 MB — abaixo do limite de 100 MB do GitHub.
...
- [ ] No rail, os três executivos aparecem: **Saucedo · Marissol · Ramos**, mais Outros
- [ ] Clicar em **Ramos** mostra as 5 contas dele (Ademicon, Pine, Mercantil, Vialaser, AGI)
