# ABM DataCentrics — Console de Decisores (V3)

Painel de inteligência do programa ABM 360°, entregue pela Esparta à DataCentrics.
Arquivo único de 3,6 MB, sem dependência externa — abre offline com duplo clique.
...
| Contas com perfil DISC completo | **12** · 68 decisores |
| Produtos do Catálogo DCX v10 | 13 |
| Copy por papel · Challenger · frameworks | 13 papéis |

## Abas

- **Mapa** — distribuição das contas por estado e região, com mapa interativo do Brasil
...
- **Contas com DISC** — perfil comportamental por decisor, com evidência de posts,
  esteira de toques e copy pronta; agrupado por executivo responsável
- **Sinais importantes** — contas ordenadas pela força do gatilho, com o evento que abre a janela
